...
func TestS3BucketAnalyticSupplier_Resources(t *testing.T) {
	...
	tests := []struct {
...

		{
			...
			wantErr: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketAnalyticsConfigurationResourceType, resourceaws.AwsS3BucketResourceType),
		},
		{
			...
			analyticsIDs: nil,
			listError:    awserr.NewRequestFailure(nil, 403, ""),
			wantErr:      NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketAnalyticsConfigurationResourceType, resourceaws.AwsS3BucketAnalyticsConfigurationResourceType),
		},
	}
