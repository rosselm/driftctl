...
func TestRoute53RecordSupplier_Resources(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsRoute53RecordResourceType, resourceaws.AwsRoute53ZoneResourceType),
		},
		{
			...
			listError: awserr.NewRequestFailure(nil, 403, ""),
			err:       NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsRoute53RecordResourceType, resourceaws.AwsRoute53RecordResourceType),
		},
	}
