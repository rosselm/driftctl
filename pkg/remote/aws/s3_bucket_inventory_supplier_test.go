...
func TestS3BucketInventorySupplier_Resources(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketInventoryResourceType, resourceaws.AwsS3BucketResourceType),
		},
		{
			...
			inventoriesIDs: nil,
			listError:      awserr.NewRequestFailure(nil, 403, ""),
			wantErr:        NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketInventoryResourceType, resourceaws.AwsS3BucketInventoryResourceType),
		},
	}
