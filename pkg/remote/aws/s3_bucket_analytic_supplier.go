...
func (s *S3BucketAnalyticSupplier) Resources() ([]resource.Resource, error) {
	...
	if err != nil {
		return nil, NewBaseListError(err, aws.AwsS3BucketAnalyticsConfigurationResourceType, aws.AwsS3BucketResourceType)
	}
	...
	for _, bucket := range response.Buckets {
		...
		if err := s.listBucketAnalyticConfiguration(*bucket.Name, region); err != nil {
			return nil, NewBaseListError(err, aws.AwsS3BucketAnalyticsConfigurationResourceType, aws.AwsS3BucketAnalyticsConfigurationResourceType)
		}
	}
