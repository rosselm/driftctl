...
func TestS3BucketMetricSupplier_Resources(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketMetricResourceType, resourceaws.AwsS3BucketResourceType),
		},
		{
			...
			metricsIDs: nil,
			listError:  awserr.NewRequestFailure(nil, 403, ""),
			wantErr:    NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsS3BucketMetricResourceType, resourceaws.AwsS3BucketMetricResourceType),
		},
	}
