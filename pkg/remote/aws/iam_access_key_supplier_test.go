...
func TestIamAccessKeySupplier_Resources(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamAccessKeyResourceType, resourceaws.AwsIamUserResourceType),
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamAccessKeyResourceType, resourceaws.AwsIamAccessKeyResourceType),
		},
	}
	for _, c := range cases {
