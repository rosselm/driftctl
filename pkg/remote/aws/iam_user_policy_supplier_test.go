...
func TestIamUserPolicySupplier_Resources(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamUserPolicyResourceType, resourceaws.AwsIamUserResourceType),
		},

		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamUserPolicyResourceType, resourceaws.AwsIamUserPolicyResourceType),
		},
	}
	for _, c := range cases {
