...
func TestIamUserPolicyAttachmentSupplier_Resources(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamUserPolicyAttachmentResourceType, resourceaws.AwsIamUserResourceType),
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamUserPolicyAttachmentResourceType, resourceaws.AwsIamUserPolicyAttachmentResourceType),
		},
	}
	for _, c := range cases {
