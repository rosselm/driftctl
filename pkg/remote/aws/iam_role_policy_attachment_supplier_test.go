...
func TestIamRolePolicyAttachmentSupplier_Resources(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamRolePolicyAttachmentResourceType, resourceaws.AwsIamRoleResourceType),
		},
		{
			...
			err: NewBaseListError(awserr.NewRequestFailure(nil, 403, ""), resourceaws.AwsIamRolePolicyAttachmentResourceType, resourceaws.AwsIamRolePolicyResourceType),
		},
	}
	for _, c := range cases {
