...
func (s *S3BucketInventorySupplier) Resources() ([]resource.Resource, error) {
	...
	if err != nil {
		return nil, NewBaseListError(err, aws.AwsS3BucketInventoryResourceType, aws.AwsS3BucketResourceType)
	}
	...
	for _, bucket := range response.Buckets {
		...
		if err := s.listBucketInventoryConfiguration(*bucket.Name, region); err != nil {
			return nil, NewBaseListError(err, aws.AwsS3BucketInventoryResourceType, aws.AwsS3BucketInventoryResourceType)
		}
	}
